"""
Django settings for horogifts project.
...
WSGI_APPLICATION = 'horogifts.wsgi.application'
...
# For development server to serve uploaded image files
MEDIA_URL = '/media/'
